                    ...
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-2 lg:items-center">
                        ...
                        <div>
                            ...
                            <div className="mt-8 space-y-5 text-sm leading-7 text-[#20231f]/65 sm:text-base sm:leading-8">
                                <p>
                                    Patrick Elzinga en Robert Poel zijn
                                    jeugdvrienden met een gedeelde passie voor
                                    koken. Door de jaren heen deden zij ruime
                                    ervaring op als chef-koks in verschillende
                                    keukens, van grand cafés tot restaurants met
                                    een Michelinster.
                                </p>

                                <p>
                                    Voor De Bank begonnen zij met Savage in
                                    Harderwijk, waar kwaliteit en verfijning
                                    centraal stonden. Die ervaring en aandacht
                                    voor kwaliteit nemen zij mee naar Brasserie
                                    De Bank.
                                </p>
                    ...
                    <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
                        <div>
                            ...
                            <p className="mt-7 max-w-xl text-sm leading-7 text-[#20231f]/60 sm:text-base sm:leading-8">
                                De gerechten worden ambachtelijk bereid met
                                liefde en passie. Ingrediënten worden zorgvuldig
                                geselecteerd en dagelijks vers geleverd.
                            </p>

                            <p className="mt-4 max-w-xl text-sm leading-7 text-[#20231f]/60 sm:text-base sm:leading-8">
                                De menukaart beweegt mee met de seizoenen, zodat
                                er regelmatig ruimte is voor nieuwe smaken en
                                variatie.
                            </p>
                        ...
                        <div className="grid gap-5 sm:grid-cols-2">
                            ...
                            <div className="border border-[#5d6948]/15 bg-[#f7f4ee] p-8 transition hover:-translate-y-1 hover:bg-white hover:shadow-[0_18px_50px_rgba(32,35,31,0.05)]">
                                ...
                                <p className="mt-4 text-sm leading-7 text-[#20231f]/55">
                                    De menukaart wisselt regelmatig mee met het
                                    seizoen.
                                </p>
                            </div>
                            ...
                            <div className="border border-[#5d6948]/15 bg-[#f7f4ee] p-8 transition hover:-translate-y-1 hover:bg-white hover:shadow-[0_18px_50px_rgba(32,35,31,0.05)] sm:col-span-2">
                                ...
                                <p className="mt-4 max-w-xl text-sm leading-7 text-[#20231f]/55">
                                    ...
                                    verrassingsgerechten en wisselende creaties
                                    uit de keuken.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        <div className="grid gap-6 md:grid-cols-3">
                            ...
                            <div className="border border-black/10 bg-white p-8">
                                ...
                                <p className="mt-4 text-sm leading-7 text-[#20231f]/55">
                                    Sfeervolle ruimtes voor zakelijke
                                    bijeenkomsten, met arrangementen voor lunch,
                                    high tea of diner.
                                </p>
                            </div>
                            ...
                            <div className="border border-black/10 bg-[#f7f4ee] p-8">
                                ...
                                <p className="mt-4 text-sm leading-7 text-[#20231f]/55">
                                    Ook geschikt voor bijvoorbeeld een
                                    bedrijfsborrel, verjaardag of babyshower.
                                </p>
                            </div>
                        </div>
                    </div>
