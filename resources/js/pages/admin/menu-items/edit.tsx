...
export default function Edit({ menuItem, categories }: Props) {
    ...
    return (
        <>
            <Head title={`Gerecht bewerken - ${menuItem.name}`} />
                    ...
                    <div className="mx-auto max-w-6xl">
                        ...
                        <div className="mb-10">
                            ...
                            <p className="mt-3 max-w-2xl text-sm leading-7 text-[#20231f]/50">
                                Pas de gegevens, prijzen, afbeelding en
                                publicatie-instellingen van dit gerecht aan.
                            </p>
                        </div>
                        ...
                        >
                            ...
                            <div className="space-y-8">
                                                    ...
                                                    (priceOption, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <button
                                                                ...
                                                                className="px-3 text-[9px] tracking-[0.15em] text-red-600 uppercase transition hover:text-red-800"
                                                            >
                                                                Verwijderen
                                                            </button>
                                                        </div>
                                ...
                                <section className="border border-black/10 bg-white p-6 shadow-[0_20px_60px_rgba(32,35,31,0.04)] sm:p-8">
                                    ...
                                    {menuItem.image && !data.remove_image && (
                                        <div className="mb-6">
                                            ...
                                            <button
                                                ...
                                                className="mt-3 text-[9px] tracking-[0.18em] text-red-600 uppercase transition hover:text-red-800"
                                            >
                                    ...
                                    {menuItem.image && data.remove_image && (
                                        <div className="mb-6 border border-red-200 bg-red-50 p-4">
                                            <p className="text-sm text-red-700">
                                                De huidige afbeelding wordt
                                                verwijderd wanneer je opslaat.
                                            </p>
                                            ...
                                            <button
                                                ...
                                                className="mt-3 text-[9px] tracking-[0.18em] text-[#5d6948] uppercase"
                                            >
                                                Ongedaan maken
                                            </button>
                                        </div>
                                    ...
                                    <p className="mt-2 text-xs text-[#20231f]/35">
                                        Laat leeg om de huidige afbeelding te
                                        behouden. JPG, PNG of WebP.
                                    </p>
