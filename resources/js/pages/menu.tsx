            ...
            <main className="bg-[#f7f4ee] text-[#20231f]">
                ...
                <section className="relative overflow-hidden px-6 py-24 sm:px-10 sm:py-28 lg:px-16 lg:py-32">
                    ...
                    <div className="relative mx-auto max-w-5xl text-center">
                        ...
                        <p className="mx-auto mt-7 max-w-xl text-sm leading-7 text-[#20231f]/60 sm:text-base sm:leading-8">
                            ...
                            borrel aan tafel. Bekijk hieronder onze
                            ...
                            <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-6">
                                {menus.map((menu, index) => (
                                    <Link
                                        ...
                                        className={`group relative flex min-h-[300px] flex-col justify-between overflow-hidden border border-[#5d6948]/15 bg-[#f7f4ee] p-7 transition-all duration-500 hover:-translate-y-1.5 hover:border-[#5d6948]/35 hover:shadow-[0_20px_50px_rgba(32,35,31,0.10)] sm:p-8 ${
                                    ...
                                    >
                                        {/* Background number */}
                                        <span className="pointer-events-none absolute -top-6 -right-2 font-serif text-[110px] leading-none text-[#5d6948]/5 transition duration-500 group-hover:text-[#5d6948]/10">
                                            {String(index + 1).padStart(2, '0')}
                                        </span>

                                        {/* Top */}
                                        <div className="relative flex items-start justify-between gap-5">
                                            <span className="text-[10px] tracking-[0.25em] text-[#5d6948] uppercase">
                                                Kaart{' '}
                                            ...
                                            <span className="text-right text-[10px] tracking-[0.18em] text-[#20231f]/35 uppercase">
                ...
                <section className="px-6 py-16 text-center sm:px-10 sm:py-20">
                    <div className="mx-auto max-w-xl">
                        ...
                        <Link
                            href="/reservation"
                            className="mt-8 inline-flex items-center gap-3 bg-[#20231f] px-7 py-4 text-[10px] tracking-[0.25em] text-[#f7f4ee] uppercase transition hover:bg-[#5d6948]"
                        >
                            Reserveer een tafel
                            <span>→</span>
                        </Link>
